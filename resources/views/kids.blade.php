...
@if($video->isEmpty())
<section id="innerBanners" class="">
    <div class="inner-banner-section">
        <div class="inner-banner-holder">
            <div class="container-fluid">
                <div class="coming-soon-text-holder">
                    <div class="content">
                        <h1>Coming Soon</h1>
                        <p>Stay Tuned</p>
                    </div>
    ...
    <div class="home-newdes-section">
        <div class="home-newdes-section-container">
            <div class="container-fluid ms-4">
                <span class="l-head">{{ $item->title }} </span>
                <div class="category mt-md-3 mt-3">
                    <div class="category-carousel">
                        <div id="categories" class="owl-carousel owl-theme">
                          ...
                          <div class="item">
                              <input type="radio" name="category" value="{{$item->cat_id}}" class="d-none" id="cat{{$item->cat_id}}">
                ...
                <hr class="mb-5">
                  <div class="slider-container mt-4">
                    <div class="latest-release-slider movies-page-section" >
                        <div class="row row-cols-3 row-cols-sm-2 row-cols-md-4 row-cols-lg-4 row-cols-xl-6">
                            @foreach ($allKids as $key => $videoItem)
                                <div class="item movie-new-card col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-2 ps-md-2 ps-sm-1 pe-sm-1 pe-md-2 mb-2 pe-1 ps-1" 
                                     ...
                                     <div class="cards-container">
                                        <div class="alpha-card skeleton card-for-kids">
                                            <div class="image-wrapper">
                                                <a href="{{ route('view.details', ['id' => App\Helpers\VideoHelper::encryptID($videoItem->id)]) }}"> 
                                                    <img src="https://alphastudioz.in/admin_panel/public/images/video/{{$videoItem->landscape}}" alt="">
                                                </a>
                                            </div>
                                            <div class="alpha-card-large {{ $videoItem->trailer_url ? 'movie-card' : '' }}" id="movie-card">
                                                <img src="https://alphastudioz.in/admin_panel/public/images/video/{{$videoItem->landscape}}" class="thumbnail" id="thumbnail" alt="">
                                                ...
                                                <div class="content">
                                                    <div class="button-holder row">
                                                        <div class="col-9">
                                                            <a href="{{ route('view.details', ['id' => App\Helpers\VideoHelper::encryptID($videoItem->id)]) }}"> <button class="btn-watchnow" type="button">
                                                                <i class="fa-solid fa-play"></i>&nbsp;&nbsp;
                                                                 Watch Now</button></a>
                                                            
                                                        </div>
                                                        <div class="col-3">
                                                            @include('watchlist-button', ['id' => $videoItem->id, 'type' => 'video', 'watchlist' => $watchlist])
                                                        </div>
                                                        
                                                    </div>
                                                    <ul class="animate__animated animate__fadeInUp mt-3">
                                                        <li>{{ \Carbon\Carbon::parse($videoItem->release_date)->format('Y') }}</li>
                                                        <li>&#x2022;</li>
                                                        <li> @if($videoItem->video_duration)
                                                            {{MillisecondsToTime($videoItem->video_duration)}} @else 
                                                            -
                                                        @endif </li>
                                                        <li>&#x2022;</li>
