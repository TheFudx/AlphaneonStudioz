        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-8 bg-dark">
            ...
            <section>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6">
                    @php
                        // Dummy music data for demonstration, replace with actual $musics
                        $musics = [
                            (object)[
                                'title' => 'Yeh dil hai Mushkil',
                                'thumbnail_url' => 'https://i.scdn.co/image/ab67616d0000b273ce2f3a60a0f5a9e5c4d0a1b6', // Replace with actual URL
                                'music_file' => 'https://www2.cs.uic.edu/~iokwon/samples/mp3/sample.mp3', // Replace with actual URL
                                'artists' => (object)['name' => 'Arijit Singh'],
                                'album_name' => 'Various Artists',
                                'duration' => 123000 // milliseconds
                            ],
                            (object)[
                                'title' => 'Dil Diwana',
                                'thumbnail_url' => 'https://i.scdn.co/image/ab67616d0000b273ce2f3a60a0f5a9e5c4d0a1b6', // Replace with actual URL
                                'music_file' => 'https://www.learningcontainer.com/wp-content/uploads/2020/02/Kalimba.mp3', // Replace with actual URL
                                'artists' => (object)['name' => 'Arijit Singh'],
                                'album_name' => 'Romantic Hits',
                                'duration' => 178000 // milliseconds
                            ]
                        ];

                        // Helper function for MillisecondsToTimeForMusic (assuming it's defined in your Laravel app)
                        if (!function_exists('MillisecondsToTimeForMusic')) {
