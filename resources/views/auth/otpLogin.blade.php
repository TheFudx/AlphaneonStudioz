    ...
    <div class="container" id="container"> 
        ...
        <div class="form-container sign-in-container otp-container">
            ...
            <form method="POST" action="{{ route('otp.generate') }}">
                ...
                @csrf
                        <input id="mobile_no" type="tel" maxlength="10" minlength="10"  @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{ old('mobile_no') }}" required autocomplete="mobile_no" autofocus placeholder="Enter Your Registered Mobile Number">
                        @error('mobile_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        @if (Route::has('login'))
                        <a href="{{ route('login') }}"><button class="btn-block w-100 otp-button" type="button">{{ __('Login With Email') }}</button></a> 
