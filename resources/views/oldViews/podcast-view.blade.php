...
@section('main-section')
                        ...
                        <div class="row">
                            <div class="col-9">
                                <div class="short-data position-absolute bottom-0 pb-2 col-sm-8 col-10">
                                    ...
                                    <p class="mb-2 mt-2">{{ Str::words(strip_tags($video->description), 15, '...') }}</p>
        ...
        <div class="webseries-details-container">
            <div class="webseries-data">
                <div class="row">
                    <div class="col-md-8">
                        <h2>{{ $video->name }}</h2>
                        <ul class="animate__animated animate__fadeInUp mt-1 ">
    ...
    {{-- More like this  --}}
    @include('section-wise-common', ['class'=>'podcast','title'=>'More Like This','viewall_route'=> route('movies.list'),'id' => 'webseriesslider','data' => $vidData, 'view_route'=>'view.details'])    
