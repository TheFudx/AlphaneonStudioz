...
@section('main-section')
    ...
    {{-- More Like This --}}
    @include('section-wise-common', ['class'=>'trailer','title'=>'More Like This','viewall_route'=> route('trailers.list'),'id' => 'webseriesslider','data' => $vidData, 'view_route'=>'view.details'])    
