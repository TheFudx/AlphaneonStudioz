...
$sql = "SELECT v.name as video_name, v.thumbnail_url, v.release_date, v.description, v.video_duration, v.video_1080_url, v.landscape_url, v.category_id, l.name as language_name, v.cast_id,
